...
export default function RegistroPage() {
  ...
  // Nuevo estado para la confirmación de la contraseña
  ...
  // ==========================================
    ...
    try {
      ...
      if (!respuesta.ok) {
        throw new Error(datos.detail || "Error al crear la cuenta");
      }
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center p-4 bg-[#0a0806] overflow-hidden font-sans">
      ...
      {/* Tarjeta Principal */}
      <div className="relative z-10 w-full max-w-[460px] bg-[#0f0c09]/80 backdrop-blur-xl border border-[#d4b483]/20 rounded-3xl p-10 shadow-[0_30px_100px_rgba(0,0,0,0.8)] mt-8 mb-8">
        ...
        {/* Formulario */}
        <form onSubmit={manejarRegistro} className="flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="Lector Empedernido"
          ...
          {/* Mensaje de Error (Captura tanto errores de coincidencia como del backend) */}
          {error && (
